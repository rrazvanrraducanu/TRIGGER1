...
$sql2="CREATE TRIGGER TriggerInsert BEFORE INSERT ON flowers FOR EACH ROW
    BEGIN
    INSERT INTO flower_update(nume,status,edtime) VALUES(NEW.nume, 'UPDATED', NOW());
    END";
highlight_string("CREATE TRIGGER TriggerInsert BEFORE INSERT ON flowers FOR EACH ROW
    BEGIN
    INSERT INTO flower_update(nume,status,edtime) VALUES(NEW.nume, 'UPDATED', NOW());
    END");
